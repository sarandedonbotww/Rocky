...
re-coded or modified by anshad
Tnx to afnan plk
to bring new ai
*/
...
if (conf.LANG == 'TR') {
    ...
    already_on = 'Rocky yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Rocky yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Rocky, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Rocky, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Rocky features. Turn your account into a ai chatbot!'
    already_on = 'Rocky artificial intelligence is already fully functional.'
    already_off = 'Rocky artificial intelligence is currently running semi-functional.'
    succ_on = 'Rocky Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Rocky Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
    fulleva_dsc = 'പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായ Rocky സവിശേഷതകൾ സജീവമാക്കുന്നു. നിങ്ങളുടെ അക്കൗണ്ട് ഒരു ചാറ്റ്ബോട്ടാക്കി മാറ്റുക!'
    already_on = 'Rocky കൃത്രിമബുദ്ധി ഇതിനകം പൂർണ്ണമായി പ്രവർത്തിക്കുന്നു.'
    already_off = 'Rocky AI നിലവിൽ സെമി-ഫംഗ്ഷണൽ ആണ്.'
    succ_on = 'Rocky പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായി തുറന്നു! കുറച്ച് കാത്തിരിക്കൂ! ✅'
    succ_off = 'സെമി-ഫങ്ഷണൽ ആയി Rocky സജ്ജമാക്കുക! കുറച്ച് കാത്തിരിക്കൂ! ☑️'
}
