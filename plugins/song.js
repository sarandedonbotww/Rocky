...
r_text[1] = "Rockye tholpikkaan ningalkavilla. Jeevitathil Rockye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Rocky says i love you 😘";
r_text[3] = "Rockyde yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Rocky - anshu - anshad \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Rocky,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than anshad";
...
r_text[13] = ".song adich thangalude fav song name para rocky ath download aakki theraam";
...
r_text[18] = "enikk njan und rocky uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe rocky pazhaya rocky thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik rocky";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee  Rocky";
...
r_text[31] = "My phone number is 9995390942"; 
