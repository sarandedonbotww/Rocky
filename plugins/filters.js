...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/I.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: 719999998,contextInfo: { forwardingScore: 5, isForwarded: true }, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: 719999998,contextInfo: { forwardingScore: 5, isForwarded: true }, quoted: message.data, ptt: true})
}
});
    }
